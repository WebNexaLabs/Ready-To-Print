    ...
    return (
        <div style={{ maxWidth: 1280, margin: '0 auto', padding: '60px 24px', fontFamily: "'Inter', sans-serif" }}>
            <div style={{ maxWidth: 800, margin: '0 auto' }}>
                <h1 style={{ fontSize: 36, fontWeight: 800, color: '#0F172A', marginBottom: 24 }}>Terms of Service</h1>
                ...
                <section style={{ marginBottom: 32 }}>
                    <h2 style={{ fontSize: 24, fontWeight: 700, color: '#0F172A', marginBottom: 16 }}>1. Service Description</h2>
                ...
                <section style={{ marginBottom: 32 }}>
                    <h2 style={{ fontSize: 24, fontWeight: 700, color: '#0F172A', marginBottom: 16 }}>2. User Responsibility</h2>
                    <p style={{ fontSize: 16, color: '#475569', lineHeight: 1.6, marginBottom: 12 }}>You agree to:</p>
                ...
                <section style={{ marginBottom: 32 }}>
                    <h2 style={{ fontSize: 24, fontWeight: 700, color: '#0F172A', marginBottom: 16 }}>3. Refund Policy</h2>
                    <p style={{ fontSize: 16, color: '#475569', lineHeight: 1.6 }}>
                ...
                <section style={{ marginBottom: 32 }}>
                    <h2 style={{ fontSize: 24, fontWeight: 700, color: '#0F172A', marginBottom: 16 }}>4. Intellectual Property</h2>
                    <p style={{ fontSize: 16, color: '#475569', lineHeight: 1.6 }}>
                ...
                <section style={{ marginBottom: 32 }}>
                    <h2 style={{ fontSize: 24, fontWeight: 700, color: '#0F172A', marginBottom: 16 }}>5. Limitation of Liability</h2>
                    <p style={{ fontSize: 16, color: '#475569', lineHeight: 1.6 }}>
                ...
                <section style={{ marginBottom: 32 }}>
                    <h2 style={{ fontSize: 24, fontWeight: 700, color: '#0F172A', marginBottom: 16 }}>6. Changes to Terms</h2>
                    <p style={{ fontSize: 16, color: '#475569', lineHeight: 1.6 }}>
