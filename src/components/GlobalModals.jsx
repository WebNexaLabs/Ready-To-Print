        ...
        <>
            ...
            {showSubscription && (
                <div style={{
                    ...
                    <div style={{
                        background: 'var(--bg-primary)', borderRadius: 24, padding: 0, maxWidth: 1000, width: '100%',
                        position: 'relative', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)',
                        ...
                        <button
                            ...
                            style={{
                                ...
                                width: 32, height: 32, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center',
                                cursor: 'pointer', color: 'var(--text-muted-dark)', zIndex: 20
                            }}
                        >
                        ...
                        <div style={{ width: '40%', background: 'var(--bg-accent-dark)', padding: 40, display: 'flex', flexDirection: 'column', position: 'relative' }} className="modal-left-col">
                            <div style={{
                                background: '#1E3A8A', color: '#2563EB', fontSize: 11, fontWeight: 800,
                            ...
                            <h2 style={{ fontSize: 28, fontWeight: 800, color: 'var(--text-primary)', marginBottom: 8, lineHeight: 1.2 }}>
                                Unlimited Digital Print
                            </h2>
                            <p style={{ fontSize: 14, color: 'var(--text-muted-dark)', marginBottom: 24 }}>Valid for 3 Months (90 Days)</p>

                            <div style={{ display: 'flex', alignItems: 'baseline', gap: 4, marginBottom: 32 }}>
                                <span style={{ fontSize: 40, fontWeight: 800, color: '#2563EB' }}>₹199</span>
                                <span style={{ fontSize: 12, fontWeight: 600, color: 'var(--text-disabled)' }}>Incl. of GST</span>
                            </div>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 20, flex: 1 }}>
                                {[
                                    ...
                                    <div key={i} style={{ display: 'flex', gap: 12 }}>
                                        ...
                                        <div>
                                            <h4 style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-secondary)', marginBottom: 4 }}>{item.title}</h4>
                                            <p style={{ fontSize: 13, color: 'var(--text-muted-dark)', lineHeight: 1.5 }}>{item.desc}</p>
                                        </div>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div style={{ width: '60%', padding: 40, background: 'var(--bg-primary)' }} className="modal-right-col">
                            <h3 style={{ fontSize: 18, fontWeight: 800, color: 'var(--text-primary)', marginBottom: 24, display: 'flex', alignItems: 'center', gap: 12 }}>
                            ...
                            <div style={{ marginBottom: 20 }}>
                                ...
                                <input type="text" placeholder="Enter your full name" style={{
                                    width: '100%', padding: '12px', borderRadius: 8, border: '1px solid var(--border-light)', fontSize: 14, color: 'var(--text-primary)', outline: 'none'
                                }} />
                            </div>

                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 8 }}>
                                <div>
                                    <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: 'var(--text-muted)', marginBottom: 8 }}>Mobile Number</label>
                                    <div style={{ position: 'relative' }}>
                                        <span style={{ position: 'absolute', left: 12, top: '50%', transform: 'translateY(-50%)', color: 'var(--text-muted-dark)', fontSize: 14, fontWeight: 500 }}>+91</span>
                                        <input type="tel" placeholder="98765 43210" style={{
                                            width: '100%', padding: '12px 12px 12px 48px', borderRadius: 8, border: '1px solid var(--border-light)', fontSize: 14, color: 'var(--text-primary)', outline: 'none'
                                        }} />
                                    </div>
                                </div>
                                <div>
                            ...
                            <p style={{ fontSize: 11, color: 'var(--text-disabled)', marginBottom: 32 }}>We'll send the payment receipt to this number.</p>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, marginBottom: 32 }}>
                                {/* UPI Option */}
                                <div style={{ border: '2px solid #2563EB', borderRadius: 12, padding: 16, background: 'var(--bg-accent-dark)', cursor: 'pointer' }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
                                        <div style={{ display: 'flex', gap: 12, alignItems: 'center' }}>
                                            <div style={{ width: 40, height: 40, background: 'var(--bg-primary)', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#2563EB', fontSize: 18 }}>⚡</div>
                                            <div>
                                                <p style={{ fontSize: 14, fontWeight: 700, color: 'var(--text-primary)' }}>UPI (Recommended)</p>
                                                <p style={{ fontSize: 11, color: 'var(--text-muted-dark)' }}>GPay, PhonePe, Paytm, or any BHIM UPI</p>
                                            </div>
                                        </div>
                                        <div style={{ width: 20, height: 20, borderRadius: '50%', border: '6px solid #2563EB', background: 'var(--bg-primary)' }}></div>
                                    </div>

                                    <div style={{ background: 'var(--bg-primary)', padding: 16, borderRadius: 8, border: '1px solid var(--border-light)' }}>
                                        <label style={{ fontSize: 11, fontWeight: 700, color: 'var(--text-muted-dark)', display: 'block', marginBottom: 8 }}>OR ENTER UPI ID</label>
                                        <div style={{ display: 'flex', gap: 8 }}>
                                            <input type="text" placeholder="username@upi" style={{ flex: 1, padding: '10px', borderRadius: 6, border: '1px solid var(--border-light)', fontSize: 14, outline: 'none' }} />
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', gap: 24, opacity: 0.6 }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 10, fontWeight: 600, color: 'var(--text-muted-dark)' }}>
