        ...
        <div style={{ display: 'flex', minHeight: '100vh', fontFamily: "'Inter', sans-serif" }}>
            ...
            <div className="signup-left" style={{
                ...
                <div style={{ marginBottom: 40 }}>
                    ...
                    >
                        <div style={{ width: 48, height: 48, background: 'var(--bg-primary)', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
                    <div style={{ display: 'flex', gap: 20 }}>
                        <div style={{ width: 48, height: 48, background: 'rgba(255,255,255,0.2)', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 4 }}>
                                {[1, 2, 3, 4].map(i => <div key={i} style={{ width: 6, height: 6, background: 'var(--bg-primary)', borderRadius: 1 }}></div>)}
                            </div>
                        </div>
                        <div>
                    ...
                    <div style={{ display: 'flex', gap: 20 }}>
                        <div style={{ width: 48, height: 48, background: 'rgba(255,255,255,0.2)', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                            <div style={{ width: 2, height: 12, background: 'var(--bg-primary)', borderRadius: 2 }}></div>
                            <div style={{ width: 12, height: 2, background: 'var(--bg-primary)', borderRadius: 2, marginLeft: -7, marginTop: 10 }}></div>
                        </div>
                        <div>
                    ...
                    <div style={{ display: 'flex', gap: 20 }}>
                        <div style={{ width: 48, height: 48, background: 'rgba(255,255,255,0.2)', borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                            <div style={{ width: 20, height: 14, border: '2px solid #fff', borderRadius: 4, position: 'relative' }}>
                                <div style={{ position: 'absolute', top: -6, right: -6, width: 10, height: 10, background: 'var(--bg-primary)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                ...
                <div style={{ marginTop: 'auto', paddingTop: 60, borderTop: '1px solid rgba(255,255,255,0.2)', display: 'flex', alignItems: 'center', gap: 16 }}>
                    <div style={{ display: 'flex' }}>
                        {[1, 2, 3].map(i => (
                            <div key={i} style={{ width: 32, height: 32, borderRadius: '50%', background: 'var(--bg-primary)', border: '2px solid #1E40AF', marginLeft: i > 1 ? -10 : 0 }}></div>
                        ))}
                    </div>
            ...
            <div className="signup-right" style={{
                flex: 1, background: 'var(--bg-primary)', padding: '60px 80px',
                ...
                <div style={{ maxWidth: 480, margin: '0 auto', width: '100%' }}>
                    ...
                    <h2 style={{ fontSize: 32, fontWeight: 800, color: 'var(--text-primary)', marginBottom: 12 }}>Create your Account</h2>
                    <p style={{ color: 'var(--text-muted-dark)', marginBottom: 32, lineHeight: 1.6, fontSize: 14 }}>
                        ...
                        {!showOtpInput ? (
                            <>
                                <div style={{ marginBottom: 20 }}>
                                    <label style={{ display: 'block', fontSize: 14, fontWeight: 600, color: 'var(--text-tertiary)', marginBottom: 8 }}>Full Name</label>
                                    <div style={{ position: 'relative' }}>
                                        <User style={{ position: 'absolute', left: 14, top: 12, width: 18, height: 18, color: 'var(--text-disabled)' }} />
                                        <input
                                            type="text"
                                            ...
                                            style={{
                                                ...
                                                border: '1px solid var(--border-light)', fontSize: 15, color: 'var(--text-primary)', outline: 'none'
                                            }}
                                        />
                                    </div>
                                </div>
                                ...
                                <div style={{ marginBottom: 20 }}>
                                    ...
                                    <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                                        <div style={{
                                            ...
                                            fontSize: 15, fontWeight: 600, color: 'var(--text-muted-dark)', borderRight: '1px solid var(--border-light)', paddingRight: 8
                                        }}>
                                            +91
                                        </div>
                                        <input
                                ...
                                <div style={{ marginBottom: 24 }}>
                                    <label style={{ display: 'block', fontSize: 14, fontWeight: 600, color: 'var(--text-tertiary)', marginBottom: 8 }}>Create Password</label>
                                    <div style={{ position: 'relative' }}>
                                    ...
                                    <p style={{ fontSize: 11, color: 'var(--text-muted-dark)', marginTop: 6 }}>Minimum 8 characters with a mix of letters and numbers.</p>
                                </div>
                            ...
                            <div style={{ marginBottom: 32 }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                                    <label style={{ fontSize: 14, fontWeight: 600, color: 'var(--text-tertiary)' }}>Enter Email OTP</label>
                                ...
                                <div style={{ position: 'relative' }}>
                                    ...
                                    <input
                                        ...
                                        style={{
                                            width: '100%', padding: '12px 12px 12px 42px', borderRadius: 8,
                                            border: '1px solid var(--border-light)', fontSize: 18, color: 'var(--text-primary)', outline: 'none',
                                            letterSpacing: '0.2em'
                                        }}
                                        autoFocus
                                    />
                                </div>
                                <p style={{ fontSize: 13, color: 'var(--text-muted-dark)', marginTop: 8 }}>
                                    We sent a verification code to <span style={{ fontWeight: 600, color: 'var(--text-primary)' }}>{email}</span>
                                </p>
                            </div>
                        )}
                    ...
                    <div className="signup-trust-badges" style={{ marginTop: 48, display: 'flex', justifyContent: 'center', gap: 20, fontSize: 10, fontWeight: 700, color: 'var(--text-muted-dark)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
